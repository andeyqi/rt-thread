...
if PLATFORM == 'gcc':
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --libpath "' + EXEC_PATH + '/ARM/ARMCC/lib" --info sizes --info totals --info unused --info veneers --list rtthread.map --scatter "board/linker_scripts/MCXC444_flash" '
    ...
    LFLAGS += r' --strict --scatter "board/linker_scripts/MCXC444_flash" '
    ...
    LFLAGS = ' --config "board/linker_scripts/MCXC444_flash.icf"'
